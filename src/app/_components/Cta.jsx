            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="text-center space-y-4">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
                  Style Redefined: Shop the Trends 
                  <span className="block mt-2">That Define You!</span>
                </h2>
                <p className="max-w-2xl mx-auto text-lg text-white/90">
                  Discover our latest collection and express your unique style with confidence
                </p>
              </div>

              {/* CTA Button */}
              <Link href="/contact" className="group relative inline-flex items-center justify-center">
                <button className="relative px-8 py-4 bg-white hover-color font-semibold rounded-lg transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
                  Contact Us
